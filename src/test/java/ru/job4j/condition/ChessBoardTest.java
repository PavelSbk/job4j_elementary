...
public class ChessBoardTest {
    ...
    @Test
    public void towerWayIs6() {
        int x1 = 0;
        int x2 = 0;
        int y1 = 0;
        int y2 = 6;
        int result = ChessBoard.towerWay(x1, y1, x2, y2);
        int expected = 6;
        Assert.assertEquals(expected, result);
    }

    @Test
    public void towerWayIs5() {
        int x1 = 0;
        int y1 = 0;
        int x2 = 5;
        int y2 = 0;
